                    ...
                    <div>
                        <ul id="nav-list">
                            <div className="container">
                                ...
                                <li><Link to="/technologies"><span role="img" aria-label="emoji">🤖</span> Our Technologies</Link></li>
                                <li><Link to="/materials"><span role="img" aria-label="emoji">🏺</span> Our Materials</Link></li>
